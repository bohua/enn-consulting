define(["js/qlik", "jquery", "./qlik-helper"], function (qlik, $, helper) {
    ...
    window.fn.preload = function (objs, type) {
        var loadingPromises = [];

        objs.forEach(function (obj) {

            if (type === 'kpi') {
                loadingPromises.push(helper.getKpi(obj));
            } else if (type === 'chart') {
                loadingPromises.push(helper.getChart(obj));
            }
